...
class SubscriblePostTest(TestCase):
    ...
    def test_subscription_email(self):
        email = mail.outbox[0]
        expect = ['contato@eventex.com.br', 'venanciomitidieri@gmail.com']

        self.assertEqual(expect, email.to)

    def test_subscription_email_bory(self):
        email = mail.outbox[0]

        self.assertIn('Venancio Mota', email.body)
        self.assertIn('15332920784', email.body)
